...
export function Footer() {
  return <footer>
    <div><Link className="brand footer-brand" href="/" aria-label="NITO — Accueil"><Image className="brand-logo" src="/nito-logo.png" alt="Logo NITO" width={50} height={50}/><span>NITO</span></Link><p>Des expériences nature, humaines et accessibles.</p></div>
