...
export function Footer() {
  return <footer>
    ...
    <div><b>Aide et sécurité</b><Link href="/aide">Centre d’aide</Link><Link href="/annulations">Annulations</Link><Link href="/signalement-litiges">Signalements et litiges</Link><Link href="/contact">Contact</Link></div>
